// `MigrateUpArgs`/`MigrateDownArgs` son solo tipos: se importan con `import type`
// porque las migraciones se ejecutan con el runtime nativo de Node (que elimina
// tipos sin analizar el módulo) y, mezclados en un import normal, Node intenta
// resolverlos como exports reales y falla. Aplicar lo mismo a cada migración nueva.
...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TYPE "public"."enum_publications_line" AS ENUM('nuevas-vacunas-para-peces', 'enfermedades-y-resistencia-antimicrobiana', 'soluciones-omicas', 'estres-y-bienestar-animal', 'impactos-en-ecosistemas', 'resiliencia-de-la-acuicultura', 'interacciones-sustentables', 'impactos-socioeconomicos');
  ...
  CREATE TABLE "publications" (
  	...
  	"line" "enum_publications_line" NOT NULL,
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TYPE "public"."enum_publications_line";
